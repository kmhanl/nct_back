...
<div class="body_wrapper">
 <div class="list_wrapper ">
	            <table class="table_list receiptList InsertReceipt" style="border-bottom:0;">
	                ...
	                <tbody>
	                    <tr>
	                        ...
	                        <td class="tit">
	                        	<input type="hidden" name="" class="forminput02" id="infoBoardCode" value="${policyView.infoBoardCode}">
	                           	<input type="text" name="infoBoardTitle" class="forminput02" id="infoBoardTitle" value="${BoardView.infoBoardTitle}" maxlength="200">
	                    ...
	                    <tr>
	                        ...
	                        <td class="tit">
	                           	<input type="text" name="infoBoardId" class="forminput02" id="infoBoardId" value="${BoardView.infoBoardId}" style="width:50%" maxlength="20" readonly>
	                        </td>
	                    </tr>
	                    <tr>
	                        <th class="stat">
	                        ...
	                        <td>
	                           	<textarea class="rcptTechForm textareaForm" name="infoBoardContent" id="infoBoardContent" rows="12" title="">${BoardView.infoBoardContent}</textarea>
	                        </td>
	                    </tr>
	                  ...
	                  <tr>
	                         ...
	                         <td>
	                            ...
	                            <input type="radio" name="infoBoardViewYn" value="Y" id="infoBoardViewYn1" <c:if test="${BoardView.infoBoardViewYn eq 'Y'}"> checked </c:if>><label for="infoBoardViewYn1">승인</label>
	                            <input type="radio" name="infoBoardViewYn" value="N" id="infoBoardViewYn2" <c:if test="${BoardView.infoBoardViewYn eq 'N'}"> checked </c:if>><label for="infoBoardViewYn2">미승인</label>
	                         </td>
	                         </tr>
	        ...
	        <div class="WriteBtnWrapper">
            	...
            	<a href="javascript:void(0);" class="Btn policySave">수정</a>
            </div>
		</div>
