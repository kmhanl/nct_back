                ...
                <div class="main_body" style="height:calc(100%);    flex-direction: column;">
					...
					<div class="ansDataTapBox">
						<ul class="ansDataTapList">
							<li class="TapOn"><a href="/rsc/ansDataList01.do" class="ansDataTapItem">재직 외국인 근로자 상세 현황 </a></li>
							<li><a href="/rsc/ansDataList02.do" class="ansDataTapItem">퇴직 외국인 근로자 상세 현황 </a></li>
						</ul>
					</div>
