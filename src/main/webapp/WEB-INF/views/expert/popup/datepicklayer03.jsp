...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
    <div id="Dimmed_Layer_Warpper" class="Dimmed_Layer_Warpper">
		<div id="Layer_Content_Warpper" class="Layer_Content_Warpper Layer_Content_4003">
        	<div class="layer_popup_tit">
				<h1 class="layer_tit">개최일 확정3</h1>
			...
			<div class="layer_popup_body content_01">
				<div class="DatePickInfoTop">
					...
					<div class="DatePickInfo">
						<ul>
							...
							<li>특정 전문위원의 참석 가능일을 수정 할 수 있습니다.</li>
						</ul>
					</div>
				</div>
				...
				<c:forEach items="${memberList}"
           		...
           		<div class="DatePickWrap" style="max-height: 552px;">
           			<div class="DatePickBody LayerBodySection" style="margin-right:5px;">
           				<div class="SectionTitleBox">
							<h1 class="TitleBoxTit">개최일 확정</h1>
						...
						<div class="DatePickSelWrap" style="height: calc(100% - 47px);">
							...
							<div class="DateEndSavebox">
								<p style="font-size:17px;">개회일자</p>
								<input type="hidden" class="DataComPick" id="DataComPick" value="1">
								<ul class="DateEndList">
									<li class="ChkOn"><a href="#none" class="DateEndItem">${ committeeData.committeeDatePick1DFKo }</a></li>
									<li><a href="#none" class="DateEndItem">${ committeeData.committeeDatePick2DFKo }</a></li>
									<li><a href="#none" class="DateEndItem">${ committeeData.committeeDatePick3DFKo }</a></li>
								</ul>
								<p style="font-size:17px;padding-top:10px;">열람가능일</p>
								<div class="DateEndPoint">
									<input type="input" class="DataComStr" id="DataComStr" value="">
									<span> ~ </span>
									<input type="input" class="DataComEnd" id="DataComEnd" value="">
 								</div>
							</div>
						</div>
            ...
            <div class="layer_popup_btn">
                ...
                <a href="#none" class="btn datepicksave2">개최일 확정</a>
            </div>
		</div>
	</div>
