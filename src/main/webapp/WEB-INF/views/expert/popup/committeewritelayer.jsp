	                    ...
	                    <div class="agenda_send_warp">
	                        ...
	                        <ul class="dept_list_01">
	                            	...
	                            	<li data-tech-id="KTS00712">로봇</li>
	                           		<li data-tech-id="KTS00713">수소</li>
					...
					<div class="AgendaModiForm AgendaModi01" style="display:none;">
						<div class="top_information">
	                        <ul class="top_info_list">
								...
								<li>* 검토 준비중인 안건을 선택 하여 추가 버튼을 선택하거나 드래드하여 안건을 추가 할수 있습니다.</li>
	                        </ul>
	                    </div>
	                    ...
	                    <div class="ComMemeberBox">
	                    	<div class="MemberTapBox">
	                    		<ul class=MemberTapList>
	                    			...
	                    			<li data-adm-group="AMG06"><a href="#none" class="MemberTapItem">기술간사</a>
	                    	...
	                    	<div class="MemberListBox MemberListBox0">
	                    		<ul class="ComMemList">
	                    			<li class="ComMemItem MemOn" data-adm-group="AMG05" data-id="adm_01_01">
	                    				<input type="hidden" class="AgdYn" value="Y">
	                    				<div class="ComMemItem_top">
	                    					<div class="ComMemCard">
		                    					<p>
			                    					<span class="ComMemName">홍길동</span>
			                    					<span>교수</span>
			                    					<span>홍익대학교</span>
		                    					</p>
		                    					<p>
		                    						<span class="ComMemInfo">010-2804-0aa565 | plan6ix@etfelaaiz.com</span>
		                    					</p>
		                    				
	                    					</div>
	                    					<a href="#none" class="MemAgdYN MemAgdYNOn">유효의견</a>
	                    					<a href="#none" class="MemAgdChk">안건권한</a>
	                    				</div>
	                    				<div class="MemAgendaCHListbox MALOn">
	                    			...
	                    			<li class="ComMemItem MemOn" data-adm-group="AMG05" data-id="adm_01_01">
	                    				...
	                    				<a href="#none" class="MemAgdChk">안건설정</a>
	                    			</li>
	                    			<li class="ComMemItem MemOn" data-adm-group="AMG05" data-id="adm_01_01">
	                    				<div class="ComMemCard">
	                    					<p>
					...
					<div class="AgendaModiForm AgendaModi03">
	                    ...
	                    <div class="ComSetupBox">
	                    	<div class="ComTypeBox">
	                    		통합 <input type="text" id="committee_num" name="DateFormT" value="">회차 
	                    		분야별 <input type="text" id="committee_tech_num" name="DateFormT" value=""> 회차 전문위원회
	                    	</div>
	                    	<div class="ComTypeBox">
