    ...
    <script type="text/javascript" src="/resources/js/signature.js"></script>
		<div id="Layer_Content_Warpper" class="Layer_Content_Warpper Layer_Content_5001">
        	<div class="layer_popup_tit">
				<h1 class="layer_tit">자료 열람 비밀유지의무 동의서 </h1>
			</div>
			<div class="layer_popup_body">
				<div class="secretAgreeBody">
					<h1 class="agreeTit">전문위원회 사전 자료 열람 비밀유지의무 동의</h1>
					<div class="ViewDateOn">
                		자료 열람 가능 기간 : ${ exData.committeeModiSDisp } ~ ${ exData.committeeModiEDisp }  
                	</div>
                	<p class="agreelow">
			...
			<div class="layer_popup_btn">
                <a href="#none" class="btn btn_AgreeCommite" data-admid="${user.admId }" data-exidx="${ exData.committeeIdx}">동의 및 확인</a>
            </div>
		</div>
	</div>
