...
<!--              			</li> -->
		...
		<div class="ComWriteBox">
			...
			<div class="ComBoradFrom">
				...
				<div class="OpinionBox">
					<p class="FormTit02">2.국민 경제 측면</p>
				...
				<div class="FormInfo02">
					<p>「산업기술보호법」제9조(국가핵심기술의 지정·변경 및 해제 등) ② 산업통상자원부장관 및 관계중앙행정기관의 장은 지정대상기술을 선정함에 있어서 해당기술이 국가안보 및 국민경제에 미치는 파급효과, 관련 제품의 국내외 시장점유율, 해당 분야의 연구동향 및 기술 확산과의 조화 등을 종합적으로 고려하여 필요최소한의 범위 안에서 선정하여야 한다.</p>
				</div>
