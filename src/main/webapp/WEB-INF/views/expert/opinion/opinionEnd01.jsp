		...
		<div class="ComWriteBox">
			...
			<div class="ComBoradFrom">
				...
				<div class="OpinionBox BoxLast">
					...
					<textarea name="opinion101" id="comment" rows="4" class="OpinionText OpinionText02" placeholder="검토의견을 작성해주세요."></textarea>
				</div>
				<div class="FormTitbox">
				...
				<div class="FormInfo">
					...
					<ul class="TechAreaType" data-pageidx="${ agdCode }">
						<li><a href="#none" class="TechAreaTypeItem">해당</a></li>
						<li><a href="#none" class="TechAreaTypeItem">미해당</a></li>
				...
				<div class="OpinionBox BoxLast" >
					<textarea name="opinion101" id="comment" rows="4" class="OpinionText OpinionText03" placeholder="검토의견을 작성해주세요."></textarea>
				</div>
				...
				<div class="ComBoradBtn">
					<a href="#none" class="btn ImSave02" data-pageidxs="${ agdCode }" data-agdtype="${ agdData.rcptTypeCode}">임시 저장</a>
					<a href="#none" class="btn OpSave02" data-pageidxs="${ agdCode }" data-agdtype="${ agdData.rcptTypeCode}">의견 제출</a> 
				</div>
