...
<!--              			</li> -->
		...
		<div class="ComWriteBox">
			...
			<div class="ComBoradFrom">
				...
				<div class="FormInfo">
					<p class="Infoment01">
						* 국가안보 측면의 검토에 대해 종합의견을 기술하되,<br>
						<span class="InfoMentSub">국가핵심기술 수출의 여부(수리/불수리)에 대해 명확히 선택</span>
					</p>
					<ul class="TechAreaType" data-pageidx="${ agdCode }">
						<li class="${ opinionData.committeeOptFlag eq 'F003' ? 'SelOn' : '' }"><a href="javascript:void(0);" class="TechAreaTypeItem" data-type="F005">수리</a></li>
					...
					<div class="TechAreaSelBox">
						<ul class="TechAreaSelList">
							...
							<li class="${ opinionData.techItemId eq 'NCT_KTS00701_008' ? 'SelOn' : '' }">
