...
<!--              			</li> -->
		...
		<div class="ComWriteBox">
			<div class="ComBoradTit">
				<h1>국가핵심기술 해외인수·합병 신고 검토 의견서</h1> 
			</div>
				...
				<div class="FormInfo">
					<p class="Infoment01">
						* 국가안보 측면의 검토에 대해 종합의견을 기술하되,<br>
						<span class="InfoMentSub">기술 수출의 여부(수리/불수리)에 대해 명확히 기재</span>
					</p>
					<ul class="TechAreaType" data-pageidx="${ agdCode }">
						<li class="SelOn"><a href="#none" class="TechAreaTypeItem">수리</a></li>
						<li><a href="#none" class="TechAreaTypeItem">불수리</a></li>
						<li><a href="#none" class="TechAreaTypeItem">조건부 수리</a></li>
