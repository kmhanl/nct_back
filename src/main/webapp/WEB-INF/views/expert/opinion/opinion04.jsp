		...
		<div class="ComWriteBox">
			...
			<div class="ComBoradFrom">
				...
				<div class="OpinionBox">
					...
					<p class="FormTit03">- 국가 경제에 미치는 영향</p>
					<div class="FormTip01">
						<p>*세부심의기준</p>
						<ul class="FormTipList">
							<li>① GDP․수출․고용 등에 미치는 영향</li>
							<li>② 지역경제에 미치는 영향</li>
						</ul>
					</div>
					<textarea name="opinion101" id="comment" rows="4" class="OpinionText2" placeholder="검토의견을 작성해주세요."></textarea>
				...
				<div class="FormInfo">
					<p class="Infoment01">
						* 1+2의 검토에 대해 종합의견을 기술하되, <br>
						<span class="InfoMentSub">국가핵심기술 수출의 여부(승인/불승인)에 대해 명확히 선택</span>
					</p>
					<ul class="TechAreaType" data-pageidx="${ agdCode }">
						<li class="SelOn"><a href="#none" class="TechAreaTypeItem">승인</a></li>
						<li><a href="#none" class="TechAreaTypeItem">불승인</a></li>
						<li><a href="#none" class="TechAreaTypeItem">조건부승인</a></li>
				...
				<div class="FormInfo02">
					<p>「산업기술보호법」제11조(국가핵심기술의 수출 등) ② 산업통상자원부장관은 제1항의 규정에 따른 승인신청에 대하여 국가핵심기술의 수출에 따른 국가안보 및 국민경제적 파급효과 등을 검토하여 관계중앙행정기관의 장과 협의한 후 위원회의 심의를 거쳐 승인할 수 있다.</p>
				</div>
